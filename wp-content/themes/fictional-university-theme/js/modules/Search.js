            ...
            <div class="one-third">
              ...
              ${
                results.programs.length
                  ? `<ul class="link-list min-list"> `
                  : `<p>No programs match the search.<a href="${universityData.root_url}/programs">View all programs</a></p>`
              }
                  ${results.programs
                    .map(
                      (item) =>
                      ...
                      (item) =>
                        ...
                        <li class="professor-card__list-item">
                          <a class="professor-card" href="${item.link}">
                            ...
                            src="${item.image}">
                            <span class="professor_card__name">${item.title}</span>
                          </a>
                        </li>
                        `
                    )
            ...
            <div class="one-third">
              ...
              ${
                results.events.length
                  ? ``
                  : `<p>No events match the search. <a href="${universityData.root_url}/events">View all events</a></p>`
              }
                  ${results.events
                    .map(
                      (item) =>
